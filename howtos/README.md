...
These files are the best places to go to understand how gulls work.
...
1. [*Simplest*](https://charlieroberts.github.io/gulls/howtos/1_simplest) - the smallest gulls project needed to get a fullscreen fragment shader presented on screen.
2. [*One Uniform*](https://charlieroberts.github.io/gulls/howtos/2_one_uniform) - adding a single uniform to a fragment shader, and setting up the CPU to use it for communication with the GPU
3. [*Using coordinates*](https://charlieroberts.github.io/gulls/howtos/3_using_coordinates) - by passing the canvas resolution to our shader as a uniform, we can create normalized coordinates for each pixel we're operating on.
...
11. [*Compute with position*](https://charlieroberts.github.io/gulls/howtos/11_compute_with_position) - Performing compute shader computations for every pixel on the screen.
12. [*Particle*](https://charlieroberts.github.io/gulls/howtos/12_particle) - A single instanced particle drawn with a vertex shader.
